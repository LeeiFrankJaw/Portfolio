...
encoding_1001 = list( ( G * Vec(G.D[1], {0:one, 1:0, 2:0, 3:one}) ).f.values() )


## Task 3
# Express your answer as an instance of the Mat class.
R = Mat( (set(range(4)), set(range(7))), {(0,6):1, (1,5):1, (2,4):1, (3,2):1} )
...
def find_error(syndrome):
    ...
    i = 4*GF2int(syndrome[0]) + 2*GF2int(syndrome[1]) + GF2int(syndrome[2]) - 1
    return Vec(set(range(7)), {i:one} if i>=0 else {})
